...
export default function RecommendApiCard({heading, text, time, tick, trend}) {
  return (
    <div className="flex flex-col  border mx-2 border-gray-200 rounded p-3">
      <div className="flex justify-between">
        <div className="w-10 h-10 rounded-full bg-black"></div>
        <div className="text-gray-700"><Image src={'/icons/bookmark.svg'} alt="Button Icon" width={24} height={24}/>
        </div>
      </div>
