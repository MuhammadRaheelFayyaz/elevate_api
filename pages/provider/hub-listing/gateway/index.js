...
export default function Home() {
    ...
    return (
      <HubListingLayout>
        ...
        <div className='mx-3 md:mx-10 my-3 border border-gray-400 overflow-hidden rounded-lg'>
            ...
            <div className="p-4">
                ...
                <Typography variant='xs' className='mb-4' text="Secret request headers and parameters will be transparently added to every request made by a client" />
                <div>
                    <div className="flex gap-3 items-center border-b-[1px] border-gray-200 pb-2">
                        ...
                        <Input placeholder='Description (Optional)' wrapperClassname='!mb-0' className='!h-[38px]' />
                    </div>
                    <div className="flex gap-3 items-center justify-between border-b-[1px] border-gray-200 py-2">
                        <Typography text='Name' className='w-[calc(100%_/_4)] pl-1' variant='small' />
                        <Typography text='Value' className='w-[calc(100%_/_4)] pl-1' variant='small' />
                        <Typography text='Type' className='w-[calc(100%_/_4)] pl-1' variant='small' />
                        <Typography text='Description (optional)' className='w-[calc(100%_/_4)] pl-1' variant='small' />
                    </div>
                </div>
                <div className="mt-3">
                    <Typography variant='body' className='mb-2' text='Transformations' />
                    <p className="text-xs">Transformations can be used to remove, remap or add parameters in a request or a response via RapidAPI proxy. <span className="text-blue-500 cursor-pointer"> View transformation examples</span> or  <span className="text-blue-500 cursor-pointer">learn more</span> in documentation. </p>
                    <div className="flex gap-2 items-center justify-between flex-wrap my-3">
                        <div className="flex gap-2 items-center">
                            ...
                            <ul className="border rounded-[5px] overflow-hidden flex items-center min-w-fit max-w-fit h-[42px] opacity-60 ">
                                {data.map((item, index) => (
                        ...
                        <Button text='Add Transformation' className='bg-white border border-gray-300 !text-black ' icon='/icons/plus.svg' />
                    </div>
