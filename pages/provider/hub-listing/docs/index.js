    ...
    <HubListingLayout>
      <div className="relative h-full">
        <div className="pt-10 pb-6 px-6">
          ...
          <div className="w-full h-fit lg:h-[50vh] flex flex-col min-[814px]:flex-row">
        ...
        <div className="flex justify-end gap-2 border-t-[1px] border-gray-300 px-5 py-3 sticky bottom-0 left-0 bg-white">
          <Button text="Save"/>
