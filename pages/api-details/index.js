  ...
  return (
    <div>
      ...
      <div className="w-full border-b-[1px] border-gray-300 py-3">
        <div
          className="w-full max-w-[1200px] px-6 mx-auto flex justify-center min-[845px]:justify-between items-center flex-wrap gap-3">
          <div className="flex justify-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm">By <span className="text-blue-500 cursor-pointer">The Odds API</span> | Updated 5
                months ago | <span className="text-blue-500 cursor-pointer">Sports</span></p>
            </div>
          </div>
